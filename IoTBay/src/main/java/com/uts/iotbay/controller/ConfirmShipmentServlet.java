...
@WebServlet("/confirmShipment")
public class ConfirmShipmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        shipmentDao.confirmShipmentById(Integer.parseInt(request.getParameter("id")));
